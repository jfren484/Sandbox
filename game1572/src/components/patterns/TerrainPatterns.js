...
export class TerrainPatterns extends React.Component {
    render() {
        const viewBox = '0 0 80 70';

        return (
            <g stroke="black" strokeWidth="1" fill="transparent">
                <pattern id="Terrain.forest" width="1" height="1" viewBox={viewBox}>
                ...
                <pattern id="Terrain.hills" width="1" height="1" viewBox={viewBox}>
                    <path d="M 15 36 C 15 11, 40 11, 40 36" />
                    <path d="M 41 36 C 41 11, 66 11, 66 36" />
                    <path d="M 28 54 C 28 29, 53 29, 53 54" />
                </pattern>
                <pattern id="Terrain.jungle" width="1" height="1" viewBox={viewBox}>
                ...
                <pattern id="Terrain.lake" width="1" height="1" viewBox={viewBox}>
                ...
                <pattern id="Terrain.mountains" width="1" height="1" viewBox={viewBox}>
                    <polyline points="10,42 28,6 43,53" />
                    <polyline points="39,32 48,11 65,53" />
                </pattern>
                <pattern id="Terrain.plains" width="1" height="1" viewBox={viewBox}>
                    <line x1="18" y1="23" x2="38" y2="23" />
                    <line x1="28" y1="38" x2="48" y2="38" />
                    <line x1="38" y1="53" x2="58" y2="53" />
                </pattern>
                <pattern id="Terrain.swamp" width="1" height="1" viewBox={viewBox}>
                ...
                <pattern id="Terrain.unexplored" width="1" height="1" viewBox={viewBox} />
            </g>
        );
    }
}