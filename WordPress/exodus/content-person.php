...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'exodus-entry-full exodus-person-full' ); ?>>
...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'exodus-entry-short exodus-person-short' ); ?>>
